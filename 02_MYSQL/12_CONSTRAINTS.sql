...
-- 같은 내용을 두번 insert 했을때, user_no의 unique 키가 중복되게 되면서
-- [23000][1062] Duplicate entry '1' for key 'user_unique.user_no' 에러 발생
...
-- FOREIGN KEY 제약조건에 의해 테이블 간의 관계 형성됨.
...
insert into user_foreignkey1
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
values (3, 'user03', 'pass03', '이순신', '남','010-4321-5678','lee123@gmail.com',50);

-- 참조 무결성에 의해 일반적으로는 관게가 맺어진 컬럼을 변경할 수 없다.
update user_foreignkey1
set grade_code = 5
where user_no = 2; -- 에러 발생
